...
The results of the experiment are shown in the \autoref{tab:experiment_R_1_sentence_Q_fact_M_causal_table}.
...
are shown in \autoref{tab:experiment_R_1_sentence_Q_fact_M_question_answering_table}.
...
The results of the T5 conversational models this experiment can be seen in \autoref{tab:experiment_R_1_sentence_Q_fact_M_T5_table}.
...
The results of the T5 conversational models from this experiment can be seen in \autoref{tab:experiment_R_1_sentence_Q_fact_M_T5_table}. 
...
documented in \autoref{tab:experiment_Q_listBased_R_1Sentence_Q_listBased_M_causalModel_table}. 
...
The results of the QA models for this experiment are documented in \autoref{tab:experiment_Q_listBased_R_1Sentence_Q_listBased_M_QaModels_table}.
...
in \autoref{tab:experiment_Q_listBased_R_1Sentence_Q_listBased_M_T5Models_table}.
...
This experiment's results for the causal models can be observed in 
...
The experiment results for the QA models are shown in \autoref{tab:experiment_R_1_paragraph_Q_fact_M_QaModels_table}.
...
are shown in \autoref{tab:experiment_R_1_paragraph_Q_fact_M_T5Models_table}.
...
in \autoref{tab:experiment_R_1_paragraph_Q_listBased_M_causal_table}.
...
can be seen in \autoref{tab:experiment_R_1_paragraph_Q_listBased_M_QaModels_table}.
...
The results of the T5 conversational models for this experiment can be seen 
in \autoref{tab:experiment_R_1_paragraph_Q_listBased_M_T5Models_table}.
...
are stored in \autoref{tab:experiment_R_3_paragraph_Q_synthesis_M_causal_table}.
...
are documented in \autoref{tab:experiment_R_3_paragraph_Q_synthesis_M_QaModels_table}.
...
are documented in \autoref{tab:experiment_R_3_paragraph_Q_synthesis_M_T5Models_table}.
