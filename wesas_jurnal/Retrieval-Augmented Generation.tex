...
\begin{table*}[htbp]
  \caption{Experiment description} % Optional caption
  \label{tab:experiment_questions_table}  % Adding label for referencing  
    \centering
    \resizebox{\textwidth}{!}{
      \begin{tabular} {|p{0.15\linewidth}|p{0.35\linewidth}|p{0.30\linewidth}|p{0.20\linewidth}|}
        \hline
...
\begin{table*}[htbp]
  \centering
  \caption{Fact-based question, single sentence retrieval, causal models} % Optional caption
  \label{tab:experiment_R_1_sentence_Q_fact_M_casual_table}  % Adding label for referencing  
  % \resizebox{\textwidth}{!}{  % Adjusts table to fit the width of the text
