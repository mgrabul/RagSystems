...
\usepackage{hyperref}   % For hyperlinks (make sure wseas.cls doesn't already include it)
\usepackage{fancyvrb}  
\usepackage{listings}
\usepackage{pygments} % Include pygments styling
% Custom colors (if necessary)
\usepackage{xcolor}     % For text and link colors

% Define link colors (you can adjust these as needed)
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    citecolor=green,
...
used in constructing the Great Wall of
China?''}\label{experiment-4-list-based-question---what-materials-were-used-in-constructing-the-great-wall-of-china}
