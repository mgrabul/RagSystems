...
The main issue during training is that that the exact output for a 
...
The simple interpretation of \autoref{eq:self_consistency_score} is that
calculates the conditional joint probability of the answer been generated based on the question 
and the probability that the rational is generated based on the question and the
...
questions. These are types of questions that can't be answered with a simple 
